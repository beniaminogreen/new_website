...
[Here](https://github.com/beniaminogreen/quantitative_empirical_methods_qualifier/tree/main) are my answers to the August 2025 quantitative empirical methods qualifying exam.   I hope they are useful in studying for the exam, but be aware that the format is changing from an at-home to an in-person exam, so I would not over-index on past years' exams. 

Here are some miscellaneous tips for studying:

- Nothing on this exam is too difficult for someone who has taken the core sequence within the department to do, but the amount of time it will take you to get ready for the exam will depend on the number of quant classes you have taken before. In my mind, there is no reason to not take the exam first year as long as you know you can dedicate the time to studying for it. 
